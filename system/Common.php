...
if (! function_exists('app_timezone')) {
     ...
     * and convert them on the fly for the responseUser.
     */
...
if (! function_exists('db_connect')) {
    /**
     * Grabs a database connection and returns it to the responseUser.
     *
...
if (! function_exists('env')) {
    /**
     * Allows responseUser to retrieve values from the environment
