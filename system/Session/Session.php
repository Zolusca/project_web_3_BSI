...
class Session implements SessionInterface
{
    ...
    /**
     * Whether to match the responseUser's IP address when reading the session data.
     *
    ...
    /**
     * Sets responseUser data into the session.
     *
    ...
    /**
     * Get responseUser data that has been set in the session.
     *
