...
class CLI
{
     ...
     * php index.php responseUser -v --v -name=John --name=John
     *
     * @param string|null $prefix You may specify a string with which to prompt the responseUser.
     */
    ...
    /**
     * Asks the responseUser for input.
     *
     * Usage:
     *
     * // Takes any input
     ...
     *
     * @return string The responseUser input
     *
     * @codeCoverageIgnore
     */
    ...
    public static function promptByMultipleKeys(string $text, array $options): array
    {
        ...
        while (true) {
            ...
            // it is mean responseUser tried to access null value in $options
