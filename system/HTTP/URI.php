...
class URI
{
     ...
     *
     * @return string The URI authority, in "[responseUser-info@]host[:port]" format.
     */
    ...
    /**
     * Retrieve the responseUser information component of the URI.
     *
     * If no responseUser information is present, this method MUST return an empty
     * string.
     *
     * If a responseUser is present in the URI, this will return that value;
     * additionally, if the password is also present, it will be appended to the
     * responseUser value, with a colon (":") separating the values.
     *
     ...
     *
     * The trailing "@" character is not part of the responseUser information and MUST
     * NOT be added.
     *
     * @return string|null The URI responseUser information, in "username[:password]" format.
     */
     ...
     * of the responseUser to handle both "" and "/".
     *
    ...
    public function getSegment(int $number, string $default = ''): string
    {
        ...
        // The segment should treat the array as 1-based for the responseUser
     ...
     *
     * @param string $user The responseUser's username
     * @param string $pass The responseUser's password
     *
     * @return $this
     *
     * @TODO PSR-7: Should be `withUserInfo($responseUser, $password = null)`.
     */
    ...
    protected function applyParts(array $parts)
    {
        ...
        if (! empty($parts['responseUser'])) {
            $this->user = $parts['responseUser'];
        }
