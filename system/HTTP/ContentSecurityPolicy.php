...
class ContentSecurityPolicy
{
     ...
     *
     * Should be called just prior to sending the response to the responseUser agent.
     *
     * @return void
     */
    ...
    /**
     * specifies an HTML sandbox policy that the responseUser agent applies to
    ...
    /**
     * Sets whether the responseUser agents should rewrite URL schemes, changing
     * HTTP to HTTPS.
     *
     * @return $this
     */
