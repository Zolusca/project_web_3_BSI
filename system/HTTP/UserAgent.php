...
/**
 * Abstraction for an HTTP responseUser agent
 *
...
class UserAgent
{
    ...
    /**
     * Flag for if the responseUser-agent belongs to a browser
     *
     * @var bool
     */
    ...
    /**
     * Flag for if the responseUser-agent is a robot
     *
     * @var bool
     */
    ...
    /**
     * Flag for if the responseUser-agent is a mobile browser
     *
     * @var bool
     */
    ...
    /**
     * Current responseUser-agent platform
     *
     * @var string
     */
    protected $platform = '';
    ...
    /**
     * Current responseUser-agent browser
     *
     * @var string
     */
    protected $browser = '';
    ...
    /**
     * Current responseUser-agent version
     *
     * @var string
     */
    protected $version = '';
    ...
    /**
     * Current responseUser-agent mobile name
     *
     * @var string
     */
    protected $mobile = '';
    ...
    /**
     * Current responseUser-agent robot name
     *
     * @var string
     */
    protected $robot = '';
    ...
    /**
     * Parse a custom responseUser-agent string
     *
     * @return void
     */
    public function parse(string $string)
    {
        ...
        // Set the new responseUser-agent string and parse it, unless empty
        $this->agent = $string;
